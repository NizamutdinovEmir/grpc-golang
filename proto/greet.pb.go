...
func (x *NamesLists) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NamesLists) ProtoMessage() {}

func (x *NamesLists) ProtoReflect() protoreflect.Message {
	mi := &file_proto_greet_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NamesLists.ProtoReflect.Descriptor instead.
func (*NamesLists) Descriptor() ([]byte, []int) {
	return file_proto_greet_proto_rawDescGZIP(), []int{3}
}

func (x *NamesLists) GetNames() []string {
	if x != nil {
		return x.Names
	}
	return nil
...
var file_proto_greet_proto_rawDesc = string([]byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x22, 0x0a, 0x0a,
	0x4e, 0x61, 0x6d, 0x65, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x61,
	...
	0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x54,
	0x0a, 0x17, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x12, 0x19, 0x2e, 0x67, 0x72, 0x65, 0x65,
	0x74, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x4c,
	0x69, 0x73, 0x74, 0x73, 0x1a, 0x1c, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x5f, 0x73, 0x65, 0x72,
...
var file_proto_greet_proto_goTypes = []any{
	...
	(*NamesLists)(nil),    // 3: greet_service.NamesLists
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	3, // 1: greet_service.GreetService.SayHelloServerStreaming:input_type -> greet_service.NamesLists
