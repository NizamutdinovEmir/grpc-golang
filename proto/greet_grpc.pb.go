...
type GreetServiceClient interface {
	...
	SayHelloServerStreaming(ctx context.Context, in *NamesLists, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error)
...
func (c *greetServiceClient) SayHelloServerStreaming(ctx context.Context, in *NamesLists, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[NamesLists, HelloResponse]{ClientStream: stream}
...
type GreetServiceServer interface {
	...
	SayHelloServerStreaming(*NamesLists, grpc.ServerStreamingServer[HelloResponse]) error
...
func (UnimplementedGreetServiceServer) SayHelloServerStreaming(*NamesLists, grpc.ServerStreamingServer[HelloResponse]) error {
...
func _GreetService_SayHelloServerStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreetServiceServer).SayHelloServerStreaming(m, &grpc.GenericServerStream[NamesLists, HelloResponse]{ServerStream: stream})
}
